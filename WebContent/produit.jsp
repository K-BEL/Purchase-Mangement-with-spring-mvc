...
<div class="container">
  ...
  <form action="/Achat/AddProduct">
  	<div class="form-group">
      <label">id:</label>
      <input type="text" class="form-control" placeholder="saisir id du produit" name="idProduit">
    </div>
    <div class="form-group">
...
<td><a href="/Achat/DeleteProduct?idProduct=<%=p.getIdProduit()%>"><i class="fas fa-trash-alt"></i></a></td>
<td><a href="/Achat/UpdateProduct.jsp?idProduct=<%=p.getIdProduit()%>"><i class="fas fa-edit"></a></i>
</td>
      </tr>
  <% }%>
    </tbody>
